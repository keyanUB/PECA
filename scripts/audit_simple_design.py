...
def audit(output):
    ...
    result = {"version": 1, "scope": "Development-suite audit; no coding generation, no advisor calls, no independent final evaluation",
              ...
              "gaps": ["This development-suite audit does not establish final-evaluator readiness",
                       "No active experiment evidence is established by this audit",
                       "Policy-to-security-check binding and security coverage remain incomplete"],
